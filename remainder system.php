...
<div id="d1"><button class="btn" onclick="location.href='index.php'"><i class="fa fa-home"></i></button> / Remainder system</div>
	<h1>Remainder system</h1><hr>

<div style="height:10px;"></div>


<div id="cx1" style="display:inline-block;margin-left:30px;">
<button class="btn115" title="Add record"><i class="fa fa-plus"><a href="add remainder.php" style="color:white;font-family:Trebuchet MS;"> Add</a></i></button>
...
<div id="cx2" style="display:inline-block">
...
<div id="cx3" style="display:inline-block;">
